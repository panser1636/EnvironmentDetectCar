...
#define CE_LOW gpio_low(E10)
#define CE_HIGH gpio_high(E10)
#define CS_LOW gpio_low(E11)
#define CS_HIGH gpio_high(E11)
#define IRQ gpio_get_level(E15)

#define NRF24L01_CE   E10 //24L01片选信号
#define NRF24L01_CSN  E11 //SPI片选信号	   
#define NRF24L01_IRQ  E15  //IRQ主机数据输入

#define NRF24L01_IRQ_PIN_READ() gpio_get_level(NRF24L01_IRQ) // 读取IRQ电平
...
uint8_t SPI1_ReadWriteByte(uint8_t byte);																	//往串行Flash读取写入一个字节数据并接收一个字节数据
#endif