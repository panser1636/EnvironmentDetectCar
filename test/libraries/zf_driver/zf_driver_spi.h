...
typedef enum                                                                    // 枚举 SPI MISO 引脚 此枚举定义不允许用户修改
{
    ...
    SPI3_MISO_C7        = 0x04752,                                              // 0x 047[C7]  5[AF5] 2[SPI3]
    SPI3_MISO_C11       = 0x04B62,                                              // 0x 04B[C11] 6[AF6] 2[SPI3]
    SPI3_MISO_D5        = 0x06552,                                              // 0x 065[D5]  5[AF5] 2[SPI3]
    SPI3_MISO_D13       = 0x06D62,                                              // 0x 06D[D13] 6[AF6] 2[SPI3]
}spi_miso_pin_enum;
