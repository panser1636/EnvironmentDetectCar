...
#else
#define imu660ra_write_register(reg, data)        (iic_write_8bit_register(IMU660RA_IIC_INDEX, IMU660RA_DEV_ADDR, (reg), (data)))
#define imu660ra_write_registers(reg, data, len)  (iic_write_8bit_registers(IMU660RA_IIC_INDEX, IMU660RA_DEV_ADDR, (reg), (data), (len)))
#define imu660ra_read_register(reg)               (iic_read_8bit_register(IMU660RA_IIC_INDEX, IMU660RA_DEV_ADDR, (reg)))
#define imu660ra_read_registers(reg, data, len)   (iic_read_8bit_registers(IMU660RA_IIC_INDEX, IMU660RA_DEV_ADDR, (reg), (data), (len)))
#endif
#else
//-------------------------------------------------------------------------------------------------------------------
// 函数简介     IMU660RA 写寄存器
