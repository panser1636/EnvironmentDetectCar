...
static void ips200_write_command (const uint8 command)
{
    ...
    else
    {
        ...
        IPS200_RD(1);
        IPS200_WR(0);
        *(volatile uint8 *)IPS200_DATA_ADD = ((uint8)command);
        IPS200_WR(1);
        IPS200_CS(1);
        IPS200_RS(1);
    }
...
static void ips200_write_8bit_data (const uint8 dat)
{
    ...
    else
    {
        ...
        IPS200_RD(1);
        IPS200_WR(0);
        *(volatile uint8 *)IPS200_DATA_ADD = ((uint8)dat);
        IPS200_WR(1);
        IPS200_CS(1);
    }
}
...
static void ips200_write_16bit_data (const uint16 dat)
{
    ...
    else
    {
        ...
        IPS200_RD(1);
        IPS200_WR(0);
        *(volatile uint8 *)IPS200_DATA_ADD = ((uint8)(dat >> 8));
        IPS200_WR(1);
        IPS200_WR(0);
        *(volatile uint8 *)IPS200_DATA_ADD = ((uint8)(dat & 0xFF));
        IPS200_WR(1);
        IPS200_CS(1);
    }
}
